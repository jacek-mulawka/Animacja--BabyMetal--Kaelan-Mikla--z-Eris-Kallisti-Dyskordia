object Animacja__BabyMetal__Kaelan_Mikla__Form: TAnimacja__BabyMetal__Kaelan_Mikla__Form
  Left = 0
  Top = 0
  Caption = 'Animacja  BabyMetal  K'#230'lan Mikla  z  Eris  Kallisti  Dyskordia'
  ClientHeight = 482
  ClientWidth = 634
  Color = clBtnFace
  ...
  object ProgressBar1__Widoczność_Splitter: TSplitter
    Left = 0
    Top = 0
    Width = 1
    Height = 482
  ...
  object PageControl1: TPageControl
    ...
    object Opcje_TabSheet: TTabSheet
      ...
      DesignSize = (
        192
        454)
      object Schematy_Etykieta_Label: TLabel
        Left = 5
        Top = 60
        Width = 41
        Height = 13
        Hint = 'Schemat.'#13#10#13#10'<Schema.>'#13#10#13#10'<Scheme.>'
        Caption = 'Schemat'
        ParentShowHint = False
        ShowHint = True
      end
      object Animacja_Zakończona_Label: TLabel
        Left = 5
        Top = 205
        Width = 123
        Height = 13
        Hint = 
          'Animacja zako'#324'czona.'#13#10#13#10'<Animation beendet.>'#13#10#13#10'<Animation finis' +
          'hed.>'
        Caption = 'Animacja zako'#324'czona'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlue
        Font.Height = -11
        Font.Name = 'Tahoma'
      ...
      object Gra_Współczynnik_Prędkości_Etykieta_Label: TLabel
        ...
        Height = 13
        Hint = 
          'Pr'#281'dko'#347#263' animacji.'#13#10#13#10'<Animations Geschwindigkeit.>'#13#10#13#10'<Animatio' +
          'n speed.>'
        Caption = 'Pr'#281'dko'#347#263' animacji'
        ParentShowHint = False
        ShowHint = True
      end
      ...
      object Animacja_Etap_Label: TLabel
        Left = 0
        Top = 411
        Width = 192
        Height = 13
        Hint = 'Etap animacji.'#13#10#13#10'<Animationsb'#252'hne.>'#13#10#13#10'<Animation stage.>'
        Align = alBottom
        Caption = '<?>'
        ParentShowHint = False
        ShowHint = True
      ...
      object Elementy_Ilość_Label: TLabel
        Left = 75
        Top = 370
        Width = 21
        Height = 13
        Hint = 
          'Ilo'#347#263' element'#243'w.'#13#10#13#10'<Menge der Elemente.>'#13#10#13#10'<Amount of elements' +
          '.>'
        Caption = '<?>'
        ParentShowHint = False
        ShowHint = True
      end
      object X_Y_Min_Max_Label: TLabel
        Left = 5
        Top = 350
        Width = 57
        Height = 13
        Hint = 'x min: <?>;'#13#10'x max: <?>;'#13#10'y min: <?>;'#13#10'y max: <?>.'
        Caption = 'x y min max'
        ParentShowHint = False
        ShowHint = True
      end
      object Śnieg_Efekt_Ilość: TLabel
        Left = 75
        Top = 350
        Width = 21
        Height = 13
        Hint = 
          'Ilo'#347#263' element'#243'w efektu '#347'niegu.'#13#10#13#10'<Anzahl der Schneeeffektelemen' +
          'te.>'#13#10#13#10'<Number of snow effect elements.>'
        Caption = '<?>'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clNavy
        Font.Height = -11
      ...
      object Schematy_Informacja_Label: TLabel
        Left = 55
        Top = 60
        Width = 13
        Height = 13
      ...
      object Schematy_ComboBox: TComboBox
        Left = 5
        Top = 80
        Width = 180
        Height = 22
        Hint = '[Enter] - wy'#347'wietl.'#13#10#13#10'<Schau. [Eingabetaste]>'#13#10#13#10'<Show.>'
        ...
        ShowHint = True
        TabOrder = 1
        OnChange = Schematy_ComboBoxChange
        OnKeyDown = Schematy_ComboBoxKeyDown
      end
      object Animacja_Rodzaj_RadioGroup: TRadioGroup
        Left = 5
        Top = 5
        Width = 180
        Height = 50
        Hint = 'Rodzaj animacji.'#13#10#13#10'<Art Animation.>'#13#10#13#10'<Kind of animation.>'
        Caption = 'Rodzaj animacji'
        Columns = 2
        ItemIndex = 0
        Items.Strings = (
          'BabyMetal'
      ...
      object Start_BitBtn: TBitBtn
        ...
        ShowHint = True
        TabOrder = 6
        OnClick = Start_BitBtnClick
      end
      object Stop_BitBtn: TBitBtn
        Left = 115
        Top = 220
        Width = 70
        Height = 25
      ...
      object Pauza_Button: TButton
        ...
        Width = 75
        Height = 25
        Hint = 'Pauza. [P]'#13#10#13#10'<Pause.>'#13#10#13#10'<Pause.>'
        Caption = 'Pauza'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 9
      ...
      object Kamera_Ustaw_CheckBox: TCheckBox
        Left = 5
        Top = 155
        Width = 97
        Height = 17
        Hint = 
          'Automatycznie ustawiaj kamer'#281'. [K + Ctrl]'#13#10#13#10'<Positionieren Sie ' +
          'die Kamera automatisch. [K + Strg]>'#13#10#13#10'<Automatically position t' +
          'he camera.>'
        Caption = 'Ustaw kamer'#281
        Checked = True
        ParentShowHint = False
        ShowHint = True
        State = cbChecked
      ...
      object Gra_Współczynnik_Prędkości__Zmniejsz_Button: TButton
        Left = 5
        Top = 298
        Width = 20
        Height = 20
        Hint = 
          'Pr'#281'dko'#347#263' gry - [(klawiatura numeryczna) -].'#13#10#13#10'<Spielgeschwindig' +
          'keit. [(Numerische Tastatur)-]>'#13#10#13#10'<Game speed. [(numeric keyboa' +
          'rd)-]>'
        Caption = '-'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 11
        OnClick = Gra_Współczynnik_Prędkości__Zmniejsz_ButtonClick
      end
      object Gra_Współczynnik_Prędkości__Domyślny_Button: TButton
        Left = 35
        Top = 298
        Width = 20
        Height = 20
        Hint = 
          'Pr'#281'dko'#347#263' gry 1 [(klawiatura numeryczna) *].'#13#10#13#10'<Spielgeschwindig' +
          'keit. [(Numerische Tastatur)*]>'#13#10#13#10'<Game speed. [(numeric keyboa' +
          'rd)*]>'
        Caption = '1'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 12
        OnClick = Gra_Współczynnik_Prędkości__Domyślny_ButtonClick
      end
      object Gra_Współczynnik_Prędkości__Zwiększ_Button: TButton
        Left = 65
        Top = 298
        Width = 20
        Height = 20
        ...
        ShowHint = True
        TabOrder = 13
        OnClick = Gra_Współczynnik_Prędkości__Zwiększ_ButtonClick
      end
      object Przerwij_Wczytywanie_Schematu_BitBtn: TBitBtn
        Left = 80
        Top = 220
        Width = 25
        Height = 25
        Hint = 
          'Przerwij wczytywanie schematu. [Del]'#13#10#13#10'<Beenden Sie das Laden d' +
          'es Schemas. [Entfernen]>'#13#10#13#10'<Stop loading the scheme.>'
        Glyph.Data = {
          DE010000424DDE01000000000000760000002800000024000000120000000100
          0400000000006801000000000000000000001000000000000000000000000000
          80000080000000808000800000008000800080800000C0C0C000808080000000
        ...
        ShowHint = True
        TabOrder = 7
        OnClick = Przerwij_Wczytywanie_Schematu_BitBtnClick
      end
      object Informacja_Ekranowa_CheckBox: TCheckBox
        Left = 5
        Top = 135
        Width = 140
        Height = 17
        Hint = 
          'Wy'#347'wietlaj informacje na ekranie. [I]'#13#10#13#10'<Zeigen Sie Information' +
          'en auf dem Bildschirm an.>'#13#10#13#10'<Display information on the screen' +
          '.>'
        Caption = 'Informacja ekranowa'
        Checked = True
        ParentShowHint = False
        ShowHint = True
        State = cbChecked
      ...
      object Falowanie_CheckBox: TCheckBox
        Left = 5
        Top = 115
        Width = 97
        Height = 17
        Hint = 'Falowanie. [M]'#13#10#13#10'<Wogen.>'#13#10#13#10'<Waving.>'
        Caption = 'Falowanie'
        ParentShowHint = False
        ShowHint = True
        TabOrder = 2
        OnClick = Falowanie_CheckBoxClick
      end
      object Ustawiena_Według_Schematu_Ustaw_CheckBox: TCheckBox
        Left = 5
        Top = 175
        Width = 170
        Height = 17
        Hint = 
          'Automatycznie ustawiaj rodzaj animacji i falowanie wed'#322'ug ustawi' +
          'e'#324' schematu.'#13#10#13#10'<Stellen Sie die Art der Animation und das Winke' +
          'n automatisch gem'#228#223' den Schemaeinstellungen ein.>'#13#10#13#10'<Automatica' +
          'lly set animation kind and waving according to the scheme settin' +
          'gs.>'
        Caption = 'Ustawiena wed'#322'ug schematu'
        Checked = True
        ParentShowHint = False
        ShowHint = True
        State = cbChecked
      ...
      object Pasek_Postępu_Wyświetlaj_CheckBox: TCheckBox
        Left = 5
        Top = 390
        Width = 97
        Height = 17
        Hint = 
          'Wy'#347'wietlaj pasek post'#281'pu na ekranie gdy panel opcji jest ukryty.' +
          #13#10#13#10'<Fortschrittsbalken auf dem Bildschirm anzeigen, wenn das Op' +
          'tionsfeld ausgeblendet ist.>'#13#10#13#10'<Show progress bar on screen whe' +
          'n options panel is hidden.>'
    ...
    object O_Programie_TabSheet: TTabSheet
      ...
      object Źródła_Etykieta_Label: TLabel
        ...
        Margins.Bottom = 10
        Align = alTop
        Caption = #377'r'#243'd'#322'a element'#243'w graficznych u'#380'ytych w animacjach:'
        ParentShowHint = False
        ShowHint = True
        WordWrap = True
        ExplicitTop = 329
    ...
    object Konwerter_Obrazów_TabSheet: TTabSheet
      Caption = 'Konwerter'
      ImageIndex = 2
      OnMouseMove = Animacja__BabyMetal__Kælan_Mikla_MouseMove
      object Konwerter_Obrazów__Obraz_Image: TImage
        Left = 5
        Top = 95
        Width = 105
        Height = 105
      ...
      object Konwerter_Obrazów__Góra_Panel: TPanel
        Left = 0
        Top = 0
        Width = 192
        Height = 85
        ...
        DesignSize = (
          192
          85)
        object Konwerter_Obrazów__Obraz_Adres_Etykieta_Label: TLabel
          Left = 5
          Top = 5
          Width = 104
          Height = 13
          Hint = 
            'Adres pliku z obrazem.'#13#10#13#10'<Bilddateiadresse.>'#13#10#13#10'<Image file add' +
            'ress.>'
          Caption = 'Adres pliku z obrazem'
          ParentShowHint = False
          ShowHint = True
        end
        object Konwerter_Obrazów__Obraz_Adres_Edit: TEdit
          Left = 5
          Top = 25
          Width = 150
          Height = 21
        ...
        object Konwerter_Obrazów__Obraz_Adres__Szukaj_Button: TButton
          Left = 160
          Top = 25
          Width = 25
          Height = 25
          Hint = 'Szukaj.'#13#10#13#10'<Suchen.>'#13#10#13#10'<Search.>'
          Anchors = [akTop, akRight]
          Caption = '...'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 1
          OnClick = Konwerter_Obrazów__Obraz_Adres__Szukaj_ButtonClick
        end
        object Konwerter_Obrazów__Obraz_Wczytaj_Button: TButton
          Left = 5
          Top = 55
          Width = 55
          Height = 25
          Hint = 'Wczytaj.'#13#10#13#10'<Laden.>'#13#10#13#10'<Load.>'
          Caption = 'Wczytaj'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 2
          OnClick = Konwerter_Obrazów__Obraz_Wczytaj_ButtonClick
        end
        object Konwerter_Obrazów__Obraz_Zapisz_Button: TButton
          Left = 125
          Top = 55
          Width = 55
          Height = 25
          Hint = 
            'Zapisz obraz jako schemat.'#13#10#13#10'<Speichern Sie das Bild als Schema' +
            '.>'#13#10#13#10'<Save the image as a scheme.>'
          Caption = 'Zapisz'
          ParentShowHint = False
          ShowHint = True
          TabOrder = 4
          OnClick = Konwerter_Obrazów__Obraz_Zapisz_ButtonClick
        end
        object Konwerter_Obrazów__Obraz_Konwertuj_Button: TButton
          Left = 65
          Top = 55
          Width = 55
          Height = 25
          Hint = 
            'Konwertuj obraz.'#13#10#13#10'<Konvertieren Sie das Bild.>'#13#10#13#10'<Convert the' +
            ' picture.>'
          Caption = 'Konwertuj'
          ParentShowHint = False
          ShowHint = True
  ...
  object Gra_GLScene: TGLScene
    ...
    object Informacja_Ekranowa_GLHUDSprite: TGLHUDSprite
      ...
      Position.Coordinates = {0000A04200007041000000000000803F}
      Pickable = False
      Width = 160.000000000000000000
      Height = 30.000000000000000000
      Rotation = 0.000000000000000000
    end
    object Informacja_Ekranowa_GLHUDText: TGLHUDText
      Pickable = False
  ...
  object Konwerter_Obrazów__OpenDialog: TOpenDialog
    Filter = 
      'Obrazki|*.bmp;*.gif;*.jpg;*.jpeg;*.png;*.tif;*.tiff|Wszystkie pl' +
      'iki|*.*'
    Options = [ofEnableSizing]
    Left = 365
    Top = 330
  end
  object Kursor_GLAsyncTimer: TGLAsyncTimer
    OnTimer = Kursor_GLAsyncTimerTimer
  ...
  object Informacja_Ekranowa_Timer: TTimer
    Enabled = False
    Interval = 3000
    OnTimer = Informacja_Ekranowa_TimerTimer
    Left = 230
    Top = 280
  end
end
